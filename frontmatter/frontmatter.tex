...
% -- The graduate school requires this page be numbered (although I think it would look better without it!)
\newpage
\thispagestyle{plain}      % -- Has to include page number
...
% -- Again, could \input{} text for this
\newpage
\thispagestyle{plain}
\phantomsection      % -- For hyperref location
